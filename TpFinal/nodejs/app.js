...
const uri = 'mongodb+srv://fsdarer:fsdarer2@cluster0.a2q9v.mongodb.net/myBooks?retryWrites=true&w=majority';
...
app.post("/persona", async (req, res) => {
    try { 
        if(!req.body.nombre || !req.body.apellido || !req.body.alias || !req.body.email || !req.body.telefono){
            throw new Error ('No enviaste los datos necesarios');
        }
...
app.put("/persona/:id", async (req, res) => {
    try {
        ...
        const personaCambiada = await PersonaModel.findByIdAndUpdate(req.params.id, {telefono: req.body.telefono}, {new:true});
...
app.post("/libro", async (req, res) => {
    try {
        if(!req.body.nombre || !req.body.descripcion || !req.body.genero || !req.body.persona){
            throw new Error ('No enviaste los datos necesarios');
        }
